...
[[nodiscard]] auto install_base(const InstallContext& ctx) noexcept
    -> std::expected<void, std::string>;

/// Installs the selected desktop environment.
[[nodiscard]] auto install_desktop(std::string_view desktop, const InstallContext& ctx) noexcept
    -> std::expected<void, std::string>;

/// Pacstrap phase only.
[[nodiscard]] auto install_desktop_packages(std::string_view desktop, const InstallContext& ctx) noexcept
    -> std::expected<void, std::string>;
