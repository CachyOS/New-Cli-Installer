...
TEST_CASE("systemd_repart")
{
    ...
    SECTION("encrypt mode to string test")
    {
    ...
    SECTION("empty mode to string test")
    {
    ...
    SECTION("generate repart config content test")
    {
    ...
    SECTION("convert partition to repart test")
    {
    ...
    SECTION("convert partitions to repart test")
    {
