...
TEST_CASE("display_manager")
{
    ...
    SECTION("display_manager::from_string")
    {
        SECTION("known names")
        {
    ...
    SECTION("display_manager::enable")
    {
    ...
    SECTION("display_manager::pick_lightdm_greeter")
    {
    ...
    SECTION("display_manager::configure_lightdm_greeter")
    {
