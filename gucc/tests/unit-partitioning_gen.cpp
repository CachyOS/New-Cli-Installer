...
TEST_CASE("partitioning_gen")
{
    ...
    SECTION("partition schema from config test")
    {
    ...
    SECTION("partition schema validation test")
    {
    ...
    SECTION("partition schema preview test")
    {
